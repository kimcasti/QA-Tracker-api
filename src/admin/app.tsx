...
import qaTrackerAdminLogo from './extensions/qa-tracker-admin-logo.svg';
...
const qaTrackerLightTheme = extendTheme(lightTheme, {
  ...
  shadows: {
    focus: 'inset 2px 0px 0px rgb(18, 63, 104), inset 0px 2px 0px rgb(18, 63, 104), inset -2px 0px 0px rgb(18, 63, 104), inset 0px -2px 0px rgb(18, 63, 104)',
  ...
  config: {
    ...
    translations: {
      es: {
        ...
        'Auth.form.welcome.subtitle': 'Inicia sesión para administrar el backend de QA Tracker.',
        'Auth.form.welcome.title': 'Bienvenida a QA Tracker',
        'HomePage.header.subtitle': 'Administra modelos, contenido y permisos de tu plataforma QA.',
        ...
        'Settings.application.description': 'Configuración global del panel administrativo de QA Tracker.',
